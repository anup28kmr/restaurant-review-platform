package com.ak.restaurant.manual;
...
import com.ak.restaurant.services.impl.RandomGeoLocationService;
...
public class RestaurantDataLoaderTest {
  ...
  public void createSampleRestaurants() throws Exception {
    ...
    restaurants.forEach(restaurant -> {
      ...
      System.out.println("Created restaurant: " + restaurant.getRestaurantName());
    });
  }
