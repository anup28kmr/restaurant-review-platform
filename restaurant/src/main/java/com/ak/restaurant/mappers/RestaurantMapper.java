...
import com.ak.restaurant.domain.dtos.GeoPointDto;
...
public interface RestaurantMapper {
  ...
  RestaurantCreateUpdateRequest toRestaurantCreateUpdateRequest(RestaurantCreateUpdateRequestDto restaurant);
